...
<root>
  ...
  ├── Editor
  │   ├── norlo.Exceltocs.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── norlo.Exceltocs.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── norlo.Exceltocs.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── norlo.Exceltocs.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `norlo.Exceltocs`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package ExcelToCS Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/norlo.Exceltocs.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/norlo.Exceltocs.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/norlo.Exceltocs.Editor.Tests.asmdef`

  `Tests/Runtime/norlo.Exceltocs.Tests.asmdef`
...
Use the `Documentations~/ExcelToCS.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
